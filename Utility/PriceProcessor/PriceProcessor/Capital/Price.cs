...
namespace PriceProcessor.Capital
{
    ...
    {       
        ...
        public Price(CapitalProcessor processor)
        {
            m_Processor = processor;
        }
        public Price(CapitalProcessor processor, short stockIdx, SKFOREIGN foreign)
            : this(processor)
        {
            StockIdx = stockIdx;
            Update(stockIdx, foreign);
        }
        public Price(CapitalProcessor processor, short stockIdx, int[] bid, int[] ask, int[] bidqty, int[] askqty)
            : this(processor)
        {
            StockIdx = stockIdx;
            Update(stockIdx, bid, ask, bidqty, askqty);
        }
        public Price(CapitalProcessor processor, short stockIdx, SKFOREIGNTICK tick)
            : this(processor)
        {
            StockIdx = stockIdx;
