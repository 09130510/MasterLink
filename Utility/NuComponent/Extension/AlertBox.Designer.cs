namespace Util.Extension
{
	partial class AlertBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.lstMsg.DrawItem += new System.Windows.Forms.DrawItemEventHandler(this.lstMsg_DrawItem);
			this.lstMsg.MeasureItem += new System.Windows.Forms.MeasureItemEventHandler(this.lstMsg_MeasureItem);
			// 
			// txtMsg
			// 
