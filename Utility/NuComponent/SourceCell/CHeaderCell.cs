...
namespace SourceCell
{
	...
	/// 欄標題
	/// </summary>
	public class CHeaderCell : CellBase
	{		
		/// <summary>
		/// 色彩表現方式
		/// </summary>
		/// <param name="colorStyle"></param>
		public delegate void SetStyle(BackgroundColorStyle colorStyle);
		...
		/// Cell
		/// </summary>		
		private SourceGrid.Cells.ColumnHeader field;
		/// <summary>
		/// Value
		/// </summary>
		...
		private BackgroundColorStyle colorStyle = BackgroundColorStyle.Linear;
		#endregion
		...
		/// </summary>
		public override SourceGrid.Cells.ICell Cell { get { return field; } protected set { field = (SourceGrid.Cells.ColumnHeader)value; } }
		/// <summary>
		/// Cell
		/// </summary>
		public SourceGrid.Cells.ColumnHeader Field
		{
			get { return field; }
			private set { }
		}
		...
		public bool Sortable
		{
			...
			set
			{
				...
				if (field != null)
				{
					field.AutomaticSortEnabled = value;
				}
			}
		}
		/// <summary>
		...
		public new FontName FontName
		{
			...
			set
			{
				...
				if (field != null)
				{
					SetFontType((SourceGrid.Cells.Views.ColumnHeader)field.View, fontname.ToString(), fontsize, fontstyle);
				}
			}
		}
		/// <summary>
		...
		public override bool Enable
		{
			...
			set
			{
				...
				if (field != null)
				{
					...
					{
						field.Editor = new SourceGrid.Cells.Editors.EditorBase(typeof(string));
					}
		...
		/// 色彩表現方式
		/// </summary>
		public BackgroundColorStyle ColorStyle
		{
		...
		public override void SetBackColor(object _Color)
		{
			if (field != null)
			{
				...
				{
					((SourceGrid.Cells.Views.ColumnHeader)field.View).Background = null;
					DevAge.Drawing.VisualElements.ColumnHeader bg = new DevAge.Drawing.VisualElements.ColumnHeader();
					bg.Border = DevAge.Drawing.RectangleBorder.CreateInsetBorder(1, BorderShadowColor, BorderLightColor);
					bg.BackgroundColorStyle = ColorStyle;
					if (_Color != null)
					{
					...
					((SourceGrid.Cells.Views.ColumnHeader)field.View).Background = bg;
		...
		/// </summary>
		/// <param name="colorStyle"></param>
		public void SetColorStyle(BackgroundColorStyle colorStyle)
		{
			if (field != null)
			{
				if (field.Grid != null && field.Grid.InvokeRequired)
				{
					...
					SetStyle d = new SetStyle(SetColorStyle);
					field.Grid.Invoke(d, new object[] { colorStyle });
				}
				else
				{
					((SourceGrid.Cells.Views.ColumnHeader)field.View).Background = null;					
		...
		private void SetCell()
		{
			...
			bg.BackColor = DefaultBackColor;
			bg.BackgroundColorStyle = ColorStyle;
			SourceGrid.Cells.Views.ColumnHeader v = new SourceGrid.Cells.Views.ColumnHeader();
			//對齊方式
			...
			field = new SourceGrid.Cells.ColumnHeader(fvalue);
			field.View = v;
			//排序功能
			field.AutomaticSortEnabled = sortable;
