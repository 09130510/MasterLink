// Ivan download from "http://www.codeproject.com/Articles/7853/NotifyWindow-A-different-MSN-Messenger-style-notif"
...
namespace NuDotNet.CustomUIControls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
        ...
        public void SetBackgroundBitmap(string strFilename, Color transparencyColor, int Width, int Height)
        {
            Bitmap bmp = new Bitmap(strFilename);
            BackgroundBitmap = new Bitmap(bmp, new Size(Width, Height));
            Width = BackgroundBitmap.Width;
            Height = BackgroundBitmap.Height;
            Region = BitmapToRegion(BackgroundBitmap, transparencyColor);
        }
