...
NuBufferAllocType_t NuBufferMalloc = {&NuBufferMallocAlloc, &NuBufferMallocFree, &NuBufferMallocGet, &NuBufferMallocSet};
...
NuBufferAllocType_t NuBufferMmap = {&NuBufferMmapAlloc, &NuBufferMmapFree, &NuBufferMmapGet, &NuBufferMmapSet};
