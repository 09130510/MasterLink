...
NuSocketType_t InetDgrmClnt = {"InetDgrmClnt", NuSocketTypeProperty_TargetAddr|NuSocketTypeProperty_TargetPort, &_DgrmClnt_SetOnline, NULL, NULL, NULL, NULL};
...
NuSocketType_t InetDgrmSvr = {"InetDgrmSvr", NuSocketTypeProperty_LocalPort|NuSocketTypeProperty_NoOnTimeout, &_DgrmSvr_SetOnline, NULL, NULL, &_DgrmSvr_Send, &_DgrmSvr_Recv};
...
NuSocketType_t InetMcstClnt = {"InetMcstClnt", NuSocketTypeProperty_TargetAddr|NuSocketTypeProperty_LocalAddr|NuSocketTypeProperty_LocalPort, &_McstClnt_SetOnline, NULL, &_McstClnt_OnEvent, &_Inet_Denied, &_Inet_Denied};
...
NuSocketType_t InetMcstSvr = {"InetMcstSvr", NuSocketTypeProperty_TargetAddr|NuSocketTypeProperty_TargetPort|NuSocketTypeProperty_LocalAddr, &_McstSvr_SetOnline, NULL, NULL, NULL, &_Inet_Denied};
...
NuSocketType_t InetStrmClnt = {"InetStrmClnt", NuSocketTypeProperty_TargetAddr|NuSocketTypeProperty_TargetPort, &_StrmClnt_SetOnline, NULL, NULL, NULL, NULL};
...
NuSocketType_t InetStrmSvr = {"InetStrmSvr", NuSocketTypeProperty_LocalPort|NuSocketTypeProperty_NoOnDisconnect|NuSocketTypeProperty_NoOnTimeout, &_StrmSvr_SetOnline, NULL, &_StrmSvr_OnEvent, &_Inet_Denied, &_Inet_Denied};
