...
NuSocketType_t UnixDgrmClnt = {"UnixDgrmClnt", NuSocketTypeProperty_TargetAddr, &_DgrmClnt_SetOnline, NULL, NULL, NULL, NULL};
...
NuSocketType_t UnixDgrmSvr = {"UnixDgrmSvr", NuSocketTypeProperty_LocalAddr|NuSocketTypeProperty_NoOnTimeout, &_DgrmSvr_SetOnline, &_Unix_SetOffline, NULL, &_DgrmSvr_Send, &_DgrmSvr_Recv};
...
/* StrmSvr */
static NuSocketType_t UnixStrmSvr_Clnt = {"UnixStrmSvr_Clnt", 0, NULL, NULL, NULL, NULL, NULL};
...
NuSocketType_t UnixStrmSvr = {"UnixStrmSvr", NuSocketTypeProperty_LocalAddr|NuSocketTypeProperty_NoOnTimeout, &_StrmSvr_SetOnline, &_Unix_SetOffline, &_StrmSvr_OnEvent, NULL, NULL};
