    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                //SessionSettings settings = new SessionSettings(@"C:\Users\nek\Code\FIX test App\acceptor.cfg");
                SessionSettings settings = new SessionSettings(@"D:\Projects\Sinopac\FixInitiator\FixInitiator\acceptor.cfg");
                //SessionSettings settings = new SessionSettings(@"D:\masterlink\Taiwan\HongKong\FixInitiator\acceptor.cfg");
        ...
        public override void onMessage(QuickFix42.NewOrderSingle order, SessionID sessionID)
        {
            ...
            QuickFix42.ExecutionReport executionReport = new QuickFix42.ExecutionReport
                                                    (genOrderID(),
                                                      genExecID(),
                                                      new ExecTransType(ExecTransType.NEW),
                                                      //new ExecType(ExecTransType.NEW),
