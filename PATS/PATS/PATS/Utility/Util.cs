...
namespace PATS.Utility
{
    ...
    {        
        ...
        public static ExchInfo ExchangeInfo { get; set; } = null;
        public static SQLTool SQL { get; set; } = null;
        ...
        {
            Center.Instance.Post(Observer.PATS_BeforeReset, "");
            _InitPATS();
            Center.Instance.Post(Observer.PATS_AfterReset, "");
        }
        ...
        private static void _InitSQL()
        {
            SQLType t;
            Enum.TryParse(INI["DEALTOEXCELDB"]["SQLTYPE"], out t);
            SQL = new SQLTool(t, INI["DEALTOEXCELDB"]["IP"], INI["DEALTOEXCELDB"]["DB"], INI["DEALTOEXCELDB"]["ID"], INI["DEALTOEXCELDB"]["PWD"]);
        }
