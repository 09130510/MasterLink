...
namespace PATS
{
    public partial class frmTick : DockContent
    {
        ...
        #region Property
        public ProductInfo ProductInfo { get { return m_Tick.ProductInfo; } }
        ...
        public frmTick(int seqno)
        {
            ...
            OnPATSChange(Observer.PATS, new Msg(null, nameof(Util.AccountInfos)));

        }
        private void frmTick_FormClosing(object sender, FormClosingEventArgs e)
        {
            Util.TickSeqNo.Remove(SeqNo);
            Center.Instance.RemoveObserver(OnPATSChange,Observer.PATS);
        }
        ...
        private void cboPID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Util.OrderRPTForm.ChangeProduct(m_Tick);
            Util.SummaryForm.ChangeProduct(m_Tick);
        }
        ...
        {
            chkSorting.Image = !chkSorting.Checked ?Resources.Ascending  : Resources.Descending;
