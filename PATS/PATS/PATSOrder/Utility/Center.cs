...
namespace PATSOrder.Utility
{
    ...
    public class Center
    {
        ...
        public delegate void MsgDelegate(string MsgName, Msg Msg);

        private static Center m_Instance;
        //private readonly Hashtable m_Hashtable;
        private readonly Dictionary<string, List<MsgDelegate>> m_Hashtable;

        private Center()
        {
            // m_Hashtable = new Hashtable();
            m_Hashtable = new Dictionary<string, List<MsgDelegate>>();
        }
        /// <summary>
        /// 訊息中心
        /// </summary>
        ...
        /// <param name="MsgName"></param>
        /// <param name="Msg"></param>
        public void Post(string MsgName,string Msg, [CallerMemberName] string Sender=null)
        {
            if (String.IsNullOrEmpty(MsgName))
            {
                throw new ArgumentNullException(@"Null Msg Name");
        ...
        public void AsyncPost(string MsgName, string Msg, [CallerMemberName] string Sender = null)
        {
            if (String.IsNullOrEmpty(MsgName))
            {
                throw new ArgumentNullException(@"Null Msg Name");
        ...
        #region Private
        private void _Publish(string MsgName, string Msg, string Sender)
        {
            //var delegatesCollection = (List<MsgDelegate>)m_Hashtable[MsgName];
            //if (delegatesCollection != null)
            //{
            ...
            //    }
            //}
            var Collections = m_Hashtable.Where(e => e.Key == MsgName || e.Key == ALL).Select(e=>e.Value);
            if (Collections != null)
            {
        ...
        private void _AsyncPublish(string MsgName, string Msg, string Sender)
        {
            //var delegatesCollection = (List<MsgDelegate>)m_Hashtable[MsgName];
