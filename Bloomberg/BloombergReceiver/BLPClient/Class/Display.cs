...
namespace BLPClient.Class
{
    public class Display: DisposableClass
    {
        ...
        public Display()
        {
            ...
            //Utility.Subscriber.OnStatusReceived += new EventHandler(Subscriber_OnStatusReceived);
            ...
            //Utility.Subscriber.OnOtherReceived += new EventHandler(Subscriber_OnOtherReceived);

            _InitCell();
        }

        #region Delegate
        //private void Subscriber_OnOtherReceived(Event eventObject, Session session)
        //{
        //    Console.WriteLine("=========================");
        //}
        ...
        //            }
        //        }
        //        Utility.Log(this, "Receive", s.ToString());
        ...
        //private void Subscriber_OnStatusReceived(Event eventObject, Session session)
        //{
        //    Console.WriteLine("**********************************************");

        //    foreach (Message msg in eventObject)
        //    {
        //        Utility.Log(this, "Status", msg.CorrelationID + "  " + msg);
