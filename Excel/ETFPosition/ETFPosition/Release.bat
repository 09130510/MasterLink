...
:CommPath
SET ProjectName=ETFPosition.sln
SET RootDestinationPath=E:\Masterlink\Release\ETFPosition\
SET SLNSource=E:\Masterlink\Excel\ETFPosition\
SET x86Release=E:\Masterlink\Excel\ETFPosition\ETFPosition\bin\x86\Release\
SET x86Debug=E:\Masterlink\Excel\ETFPosition\ETFPosition\bin\x86\Debug\
SET x64Release=E:\Masterlink\Excel\ETFPosition\ETFPosition\bin\Release\
SET x64Debug=E:\Masterlink\Excel\ETFPosition\ETFPosition\bin\Debug\
...
CALL :ColorText 0D "====================="
ECHO.
%ILMergePath%ILMerge.exe /log /target:winexe /targetplatform:v4,%Assembly40%  /out:ETFPosition.exe %x86Release%ETFPosition.exe %x86Release%AxInterop.IPUSHXLib.dll %x86Release%AxInterop.XQUOTELib.dll %x86Release%Dapper.dll %x86Release%EPPlus.dll %x86Release%INIFileParser.dll %x86Release%Interop.IPUSHXLib.dll %x86Release%Interop.XQUOTELib.dll %x86Release%log4net.dll %x86Release%PriceLib.dll %x86Release%ServiceStack.Common.dll %x86Release%ServiceStack.Interfaces.dll %x86Release%ServiceStack.Redis.dll %x86Release%ServiceStack.Text.dll      
ECHO.
CALL :ColorText 0D "=================="
CALL :ColorText D0 "[Move x86 Release]"
CALL :ColorText 0D "=================="
ECHO.
Move ETFPosition.exe %Destinationx86Release%%Ver%
...
CALL :ColorText 0D "================"
ECHO.
Copy %x86Debug%ETFPosition.exe %Destinationx86Debug%%Ver%
...
CALL :ColorText 0D "====================="
ECHO.
%ILMergePath%ILMerge.exe /log /target:winexe /targetplatform:v4,%Assembly452% /out:ETFPosition.exe %x64Release%ETFPosition.exe %x64Release%AxInterop.IPUSHXLib.dll %x64Release%AxInterop.XQUOTELib.dll %x64Release%Dapper.dll %x64Release%EPPlus.dll %x64Release%INIFileParser.dll %x64Release%Interop.IPUSHXLib.dll %x64Release%Interop.XQUOTELib.dll %x64Release%log4net.dll %x64Release%PriceLib.dll %x64Release%ServiceStack.Common.dll %x64Release%ServiceStack.Interfaces.dll %x64Release%ServiceStack.Redis.dll %x64Release%ServiceStack.Text.dll     
ECHO.
CALL :ColorText 0D "=================="
CALL :ColorText D0 "[Move x64 Release]"
CALL :ColorText 0D "=================="
ECHO.
Move ETFPosition.exe %Destinationx64Release%%Ver%
...
CALL :ColorText 0D "================"
ECHO.
Copy %x64Debug%ETFPosition.exe %Destinationx64Debug%%Ver%
