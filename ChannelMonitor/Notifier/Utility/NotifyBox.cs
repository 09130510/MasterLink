...
namespace Notifier.Utility
{
    public partial class NotifyBox : Form
    {
        ...
        private Font normalContentFont = new Font("Verdana", 12, FontStyle.Regular, GraphicsUnit.Pixel);
        private Font hoverContentFont = new Font("Verdana", 12, FontStyle.Bold, GraphicsUnit.Pixel);
        ...
        private int nBeforeDisappearBottom;
        private int m_CurrX;
        private int m_CurrY;
        ...
        public NotifyBox(IWin32Window owner, Style style)
        {
            InitializeComponent();
            ...
            NormalContentColor = HoverContentColor = NormalTitleColor = HoverTitleColor = Color.FromName($"{style}");
            //SetBackgroundBitmap(new Bitmap(GetType(), $"{style}.png"), Color.FromArgb(255, 0, 255));
            SetBackgroundBitmap(new Bitmap($"./Img/{style}.png"), Color.FromArgb(255, 0, 255));
            //m_Notify.SetCloseBitmap(new Bitmap(GetType(), $"{Style}Close.png"), Color.FromArgb(255, 0, 255), new Point(450, 5));
            SetCloseBitmap(new Bitmap($"./Img/{style}Close.png"), Color.FromArgb(255, 0, 255), new Point(25, 35));
            TitleRectangle = new Rectangle(5, 8, 76, 89);
            ContentRectangle = new Rectangle(90, 5, 390, 89);
        ...
        /// <param name="yOffset">Y Loction Shift</param>
        public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide, int yOffset=0)
        {
            ...
            switch (taskbarState)
            {
                case TaskbarStates.Hidden:
                    taskbarState = TaskbarStates.Appearing;
                    SetBounds(WorkAreaRectangle.Right - m_BGImg.Width - 17, WorkAreaRectangle.Bottom -YOffset- 15, m_BGImg.Width, 0);
        ...
        public void Update(string strTitle, string strContent)
        {
            TopMost = true;
            m_TitleText = strTitle;
            m_ContentText = strContent;
        ...
        public void Disappear(int nTimeToHide)
        {            
            if (taskbarState != TaskbarStates.Hidden)
            {
                int nEvents;
                nBeforeDisappearBottom = Bottom;
                if (nTimeToHide > 10)
                {
                    nEvents = Math.Min((nTimeToHide / 10), m_BGImg.Height);
                    nHideEvents = nTimeToHide / nEvents;
