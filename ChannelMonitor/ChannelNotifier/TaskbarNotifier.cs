...
namespace CustomUIControls
{
    ...
    public class TaskbarNotifier : System.Windows.Forms.Form
    {
        ...
        protected Color normalTitleColor = Color.FromArgb(214, 38, 38);
        protected Color hoverTitleColor = Color.FromArgb(214, 38, 38);
        protected Color normalContentColor = Color.FromArgb(214, 38, 38);
        protected Color hoverContentColor = Color.FromArgb(214, 38, 38);
        ...
        protected Font normalTitleFont = new Font("Verdana", 14, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font hoverTitleFont = new Font("Verdana", 14, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font normalContentFont = new Font("Verdana", 16, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverContentFont = new Font("Verdana", 16, FontStyle.Bold, GraphicsUnit.Pixel);
        ...
        /// </summary>
        public TaskbarNotifier(IWin32Window owner)
        {
            // Window Style
        ...
        public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
        {
            ...
            switch (taskbarState)
            {
                case TaskbarStates.hidden:
                    ...
                    SetBounds(WorkAreaRectangle.Right - BackgroundBitmap.Width - 17, WorkAreaRectangle.Bottom - 15, BackgroundBitmap.Width, 0);
                ...
                case TaskbarStates.disappearing:
                    ...
                    SetBounds(WorkAreaRectangle.Right - BackgroundBitmap.Width - 17, WorkAreaRectangle.Bottom - BackgroundBitmap.Height - 15, BackgroundBitmap.Width, BackgroundBitmap.Height);
                    timer.Interval = nVisibleEvents;
                    timer.Start();
                    Refresh();
                    break;
