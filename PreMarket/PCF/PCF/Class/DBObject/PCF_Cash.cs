...
namespace PCF.Class
{
    public class PCF_Cash
    {
        //private  string DEL = "DELETE FROM tblCashOfPCF WHERE DataDate='{0}' AND ETFCode='{1}' AND Currency='{2}' ";
        private static string DEL = "DELETE FROM tblCashOfPCF WHERE DataDate='{0}' AND ETFCode='{1}' ";
        private string MYINS = "INSERT INTO tblCashOfPCF (Identity,DataDate,ETFCode,Currency,Amount,Rate) VALUES('{0}','{1}','{2}','{3}',{4},{5}) ";
        private string MSINS = "INSERT INTO tblCashOfPCF ([Identity],DataDate,ETFCode,Currency,Amount,Rate) VALUES('{0}','{1}','{2}','{3}',{4},{5}) ";
        ...
        public PCF_Cash(string etfcode, DateTime dataDate)
        {
            ETFCode = etfcode;
            DataDate = dataDate;
        }
